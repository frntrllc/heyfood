...
pub use model::{
    ...
    HouseholdAccountBindingDigestV1, HouseholdAgeEvidenceInputV1, HouseholdAgentAccessDecisionV1,
    HouseholdAgentAccessLevelV1, HouseholdContextApplyFailureV1, HouseholdCounterExhaustedV1,
    HouseholdManagementFailureV1, HouseholdManagementLoadPurposeV1, HouseholdMemberPresentationV1,
    ...
    HouseholdPresentationValidationErrorV1, HouseholdReducerCorrelationV1, MAX_RENDERED_LINES,
    MAX_SCROLLBACK_BYTES, MAX_SCROLLBACK_ENTRIES, NativeOwnerProfileSaveStatusV1,
    OnboardingTargetV1, OperationState, OwnerProfileActionEligibilityV1,
