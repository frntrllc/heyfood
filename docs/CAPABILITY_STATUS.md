...
| Native v0.5.0 | Previous supported release | The qualified Rust recovery release superseded by v0.6.0. |
...
| macOS v0.6.0 archives | Supported | Both architectures are Developer ID signed with hardened runtime, Apple notarized, attested, and installed-artifact qualified. |
...
| Interactive TUI | Launches authenticated chat and functional read/action panels | N/A | Supported and installed-artifact qualified in v0.6.0. |
