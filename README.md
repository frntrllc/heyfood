...
supported release is `0.6.3` for macOS and Linux. It includes offline
...
Install the supported native `v0.6.3` binary on macOS or Linux:
...
The v0.6.3 release can explain its exact installed automation
...
complete twelve-stage showcase are future work rather than `v0.6.3` release
gates.
...
included in `v0.6.3`. Human progress labels stay separate from backend tool
...
showcase and real-hardware voice qualification remain post-`v0.6.3`
